    ...
    <div>
      ...
      <div className="home-carousel">
        <div id="homecarousel" class="carousel slide" data-bs-ride="carousel">
              ...
              <div className="row home-item-row">
                <div className="col-sm-8 mx-auto mt-sm-2">
                  <div className="home-carousel-detail d-flex align-items-start flex-column">
                    ...
                    <div className="home-carousel-topic fs-2 text-uppercase text-start text-white fw-bolder">
                      The Futuristic Smart Doors
                    </div>
                    <div className="home-carousel-para text-capitalize text-white text-start my-2">
                      The advancement of technology has significantly impacted
                      our daily lives, and it has made many tasks easier and
              ...
              <div className="row home-item-row">
                <div className="col-md-8 col-sm-12 mx-auto">
                  <div className="home-carousel-detail d-flex align-items-start flex-column">
                    ...
                    <div className="home-carousel-topic fs-2 text-start text-uppercase text-white fw-bolder">
                      Traditional doors vs. Smart Doors
                    </div>
                    <div className=" home-carousel-para  text-capitalize text-white text-start my-2">
                      Doors are a fundamental component of any building,
                      providing a means of access and security for its
          ...
          >
            <span
              className="carousel-control-prev-icon homecarousel-prev-btn"
              aria-hidden="true"
            ></span>
      ...
      <div className="row trendy ">
        <div className="col-md-6 col-sm-12">
          <div className="trendy-detail">
            <div className="trendy-head">A Trendy Doors For Trendy Home</div>
            ...
            <div className="text-uppercase">
              <NavLink to="/contact" className="nav-link trendy-btn ">
                Learn More
              </NavLink>
            </div>
          </div>
        ...
        <div
          className="col-md-6 trendy-img .d-sm-none .d-md-block"
          data-aos="fade-left"
        ></div>
      </div>
      ...
      <div className="service">
        <div className="row service-row">
          <div className="service-head text-capitalize">Services</div>
        </div>
        <div
          className="row service-grid"
          data-aos="fade-up"
          data-aos-offset="300"
        ...
        <div className="row row-premium">
          <div className="col-sm-12">
            <div className="premium-head">
              Upgrade Your Home Security with Our Expert Door Services
            </div>
            <div className="premium-detail" data-aos="fade-right">
              If you're in need of new doors for your home or business, or if
              your current doors need repair or maintenance, don't hesitate to
              give us a call. Our team of experienced professionals will work
              with you to find the perfect doors for your needs and budget.
              Contact us today to schedule your consultation and get started on
              improving the security and appearance of your property.
            </div>
            <NavLink to="/contact">
      ...
      <div className="product">
        <div className="row product-row">
          <div className="product-head text-capitalize">Top sales</div>
        </div>
              ...
              <div className="product-card" data-aos="flip-up">
                ...
                <div className="product-cat text-capitalize">
                  ...
                  <span className="premium-doors">
                    {" "}
                    doors <span className="prem-do"></span>
                  </span>{" "}
                </div>
              </div>
            );
        ...
        <div className="row us-row">
          <div className="col-sm-12 us-detail">
            ...
            <div className="us-para">
              We use the best Teak, Sissau and Chaap wood for our entire range
              of products and treatments. Each parts of doors pass through
              proper check before final selection. Durability, Strength and
              Attractiveness are our top most priority.
            </div>
          </div>
        </div>
      ...
      <div className="testomial">
        <div className="row testomial-row">
          <div className="testomial-head text-capitalize">clients</div>
        </div>
        <div id="testomial" class="carousel slide" data-bs-ride="carousel">
              ...
              <div className="row row-carousel-item">
                ...
                <div className="col-md-8 col-sm-12 testomial-detail">
                  ...
                  <div className="testomial-title">
                    <div className="testo-name">Ram gurung</div>
                    <div className="testo-position"> - Board Director</div>
                  </div>
            ...
            <div class="carousel-item" data-bs-interval="2000">
              <div className="row row-carousel-item">
                ...
                <div className="col-md-8 col-sm-12 testomial-detail">
                  ...
                  <div className="testomial-title">
                    <div className="testo-name">Shyam tamang</div>
                    <div className="testo-position"> - Investor</div>
                  </div>
                  <div className="testo-head">
                    Authentic and Quality Product
                  </div>
                  <div className="testo-para">
                    Goods are far better then ordered ones. You wont have false
                    advertisement.
                    <div className="testo-quote-right">
                      <i class="fa-solid fa-quote-right"></i>
                    </div>
            ...
            <div class="carousel-item">
              <div className="row row-carousel-item">
                ...
                <div className="col-md-8 col-sm-12 testomial-detail">
                  ...
                  <div className="testomial-title">
                    <div className="testo-name">Bipin yogi</div>
                    <div className="testo-position"> - businessman</div>
                  </div>
                  <div className="testo-head">Best Customer service</div>
                  <div className="testo-para">
                    Material hardness can be ensured on the spot and every doors
                    are perfectly...
                    <div className="testo-quote-right">
          ...
          <button
            ...
            type="button"
            data-bs-target="#testomial"
            data-bs-slide="prev"
          >
            <span
              class="carousel-control-prev-icon fa-solid fa-chevron-left testo-prev"
              aria-hidden="true"
            ></span>
          ...
          >
            <span
              class="carousel-control-next-icon fa-solid fa-chevron-right testo-prev"
              aria-hidden="true"
            ></span>
        ...
        <div className="row yourdesign-row">
          <div className="col-12 col-sm-9 d-flex align-items-center justify-content-center flex-column">
            ...
            <div className="yourdesign-para text-start">
              Objectively innovate empowered factory products else best
              platforms.
            </div>
          </div>
          <div className="col-12 my-sm-0 my-3 col-sm-3 d-flex align-items-center justify-content-center">
            <div
              className="yourdesign-btn btn text-uppercase"
              data-aos="fade-left"
            >
