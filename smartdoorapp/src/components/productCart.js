        ...
        <div className="row row-cart-table">
          <div className="col-12">
            <div className="cart-heading">
              ...
              <div className="cart-h text-uppercase">total price</div>
            </div>

            {/*  */}
            {cartlist?.map((product, key) => {
              return (
                <div key={key} className="cart-product-list">
                  ...
                  <div className="cart-product-quantity d-flex align-items-center">
                    <div className="price-qty text-uppercase">qty :</div>
                    <CartButton
                  ...
                  <div className="cart-product-price d-flex justify-content-around">
                    ...
                    <div
                      ...
                      onClick={() => deleteCartlist(product._id)}
                    >
          ...
          <div className="col-12 coupon-container">
            ...
            <div>
              ...
              <div className="coupon-cart">
                <div className="btn coupon-cart-update update cart">
                  <NavLink to="/product/buy-now" className="nav-link">
                    proceed to checkout
                  </NavLink>
                </div>
              </div>
