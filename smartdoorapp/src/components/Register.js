    ...
    if (usernameCheck && emailCheck && passwordCheck && confirmPassword) {
      try {
        let response = await axios.post(
          "https://smartdoor-fronted.onrender.com/register",
          formdata
        );
        ...
        <div className="message">
          {
            <h1
              style={{
                backgroundColor: `${
                  signupSucess ? "rgb(196, 196, 255)" : "rgb(251, 152, 152)"
                }`,
              }}
            >
              {Message}
      ...
      <form onSubmit={SubmitForm}>
        <div className="input-container">
          ...
          <div>
            ...
            />
            <div onClick={() => setPasswordView((prev) => !prev)}>
          ...
          <div>
            ...
            />
            <div onClick={() => setPasswordViewTwo((prev) => !prev)}>
              <i class="fa-solid fa-eye"></i>
            </div>
          </div>
