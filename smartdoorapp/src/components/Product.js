...
function Product() {
  ...
  async function getProduct() {
    try {
      let res = await axios.get(
        `https://smartdoornepal-com.onrender.com/product?page=${pageCount}&limit=20&colors=${filterColor}&category=${filtercategory}&size=${filterSize}`
      );
      ...
      setTotalProductCount(
        Math.trunc(
          checkdecimal
            ? res.data.productLenght / 15
            : res.data.productLenght / 20 + 1
        )
      );
  ...
  function deleteConfirmYes() {
    axios
      .delete(`http://localhost:3001/delete?id=${deleteID}`)
      .then((res) => {
  ...
  function paginationSelection() {
    try {
      let paginationSelection = document.querySelectorAll(
  ...
  const rosewood = () => {
    ...
    document.querySelector(".rosewood").style.border =
      "3px solid hsl(245, 92%, 67%)";
    document.querySelector(".andrateak").style.border = "0";
    document.querySelector(".color-name-rosewood").style.color =
      "hsl(245, 92%, 67%)";
    document.querySelector(".color-name-andrateak").style.color = "#000000";
  };
  const andrateak = () => {
    setFilterColor("andrateak");
    document.querySelector(".andrateak").style.border =
      "3px solid hsl(245, 92%, 67%)";
    document.querySelector(".color-name-andrateak").style.color =
      "hsl(245, 92%, 67%)";
            ...
            <div id="pagination">
              ...
              <div className="pagination-btn sm-pagination d-flex">
                ...
                {[...Array(totalProductCount)].map((e, i) => {
                  return (
                    <li
                      ...
                      key={i}
                      onClick={(e) => setpageCount(e.target.value)}
                      value={i + 1}
                    >
                      {i + 1}
                    </li>
                ...
                <button
                  ...
                  onClick={() =>
                    setpageCount((prev) =>
                      prev >= totalProductCount - 1 ? totalProductCount : ++prev
                    )
                  }
                >
        ...
        {showf ? (
          <div className="col-sm-3 col-xm-12 product-filter  filter-md">
            <div className="d-flex align-items-end justify-content-between">
              ...
              <div className="filter-clear" onClick={ClearFilterData}>
                Clear All
              </div>
            </div>
            ...
            <div className="filter-cat">
              ...
              <ul className="filter-cat-ul">
                <li className="d-flex align-items-center justify-content-start">
                  ...
                  <div className="ms-1">
                    <label htmlFor="3dDoors" className="category-label">
                      {" "}
                      3d Doors
                    </label>{" "}
                  </div>
                ...
                <li className="d-flex align-items-center justify-content-start">
                  ...
                  <div className="ms-1">
                    <label htmlFor="dd">Double Doors</label>
                  </div>
                </li>
                <li className="d-flex align-items-center justify-content-start">
                  <div>
                  ...
                  <div className="ms-1">
                    <label htmlFor="cd">Canadian Doors</label>
                  </div>
                </li>
                <li className="d-flex align-items-center justify-content-start">
                  <div>
                    <input
                      ...
                      id="md"
                      name="cat"
                      value="MEMBRANE DOORS"
                      onClick={(e) => setFiltercategory(e.target.value)}
                    />{" "}
                  </div>
                  <div className="ms-1">
                    <label htmlFor="md">Membrance Doors</label>
                  </div>
                </li>
              </ul>
            </div>
              ...
              <div className="filter-con">
                <div className="filter-size">
                  <input
                    ...
                    name="size"
                  />
                  <label htmlFor="size1"> 80 * 32</label>{" "}
                </div>
                <div className="filter-size">
                  <input
                    type="radio"
                    ...
                    name="size"
                  />
                  <label htmlFor="size2">80 * 26</label>
                </div>
                <div className="filter-size">
                  <input
                    type="radio"
                    ...
                    name="size"
                  />
                  <label htmlFor="size3">75 * 26</label>
                </div>
                <div className="filter-size">
                  <input
                    type="radio"
                    ...
                    name="size"
                  />
                  <label htmlFor="size4">72 * 26</label>
                </div>
                <div className="filter-size">
                  <input
                    type="radio"
                    ...
                    name="size"
                  />
                  <label htmlFor="size5">80 * 38</label>
                </div>
                <div className="filter-size">
                  <input
                    type="radio"
                    ...
                    name="size"
                  />
                  <label htmlFor="size6">DD80 * 19</label>
                </div>
                <div className="filter-size">
                  <input
                    type="radio"
                    ...
                    name="size"
                  />
                  <label htmlFor="size7">DD80 * 22</label>
                </div>
              </div>
            </div>
          ...
          <div className="show-product">
            <div className="show-card">
              ...
              {allproduct.map((product, key) => {
                return (
                  <div key={key} className="show-card-container">
                    <NavLink
