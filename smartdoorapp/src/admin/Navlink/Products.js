...
function Product() {
  ...
  async function getProduct() {
    try {
      let res = await axios.get(
        `https://smartdoor-fronted.onrender.com/product?page=${pageCount}&limit=20&colors=${filterColor}&category=${filtercategory}&size=${filterSize}`
      );
  ...
  function deleteConfirmYes() {
    axios
      .delete(`https://smartdoor-fronted.onrender.com/delete?id=${deleteID}`)
      .then((res) => {
                ...
                <div className="filter-cat">
                  ...
                  <ul className="filter-cat-ul">
                    <li>
                      ...
                      />{" "}
                      <label htmlFor="3D Doors">3d Doors</label>{" "}
                    </li>
                    <li>
                      <input
                        className="category"
                ...
                <div className="filter-col">
                  ...
                  <div className="filter-col d-flex">
                    <div
                      className="color"
                      value="rose wood"
                      onClick={() => setFilterColor("rose wood")}
                    ></div>
                    <div
                      className="color"
                      value="andrateak"
                      onClick={() => setFilterColor("andrateak")}
                    ></div>
                  </div>
                </div>
            ...
            <div className="col-sm-9 col-xm-12 p-0" id="product-view">
              <div className="show-product">
                <div className="show-card show-card-admin">
                  ...
                  {DeleteMessage ? (
                    <img src={"./Image/no-products.jpg"}></img>
                  ) : (
                    ""
                  )}
                        ...
                        <div className="show-card-detail p-2">
                          ...
                          <div className="d-flex w-100 justify-content-between align-items-center">
                            ...
                            <div
                              ...
                              onClick={() =>
                                DeleteConfirmBoxFunction(product._id)
                              }
                            >
